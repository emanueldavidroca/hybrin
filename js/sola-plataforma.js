...
hexagono.forEach(hex => {
    ...
    hex.addEventListener("mouseover",()=>{
        if(hex.classList.contains("administrar")){
            ...
            document.querySelector("#section-sola-plataforma-desktop .texto").style.right= "unset";
        }
        ...
        if(hex.classList.contains("diseñar")){
            ...
            document.querySelector("#section-sola-plataforma-desktop .texto").style.left= "unset";
        }
